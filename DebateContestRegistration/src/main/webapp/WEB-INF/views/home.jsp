...
<body>
	<div class="container">
		<h3
			style="margin-top: 5px; line-height: 2.5; background-color: green; padding-left: 20px">DEBATE
			CONTEST REGISTRATION - COLLEGE FEST</h3>
		<hr>
		<!-- Add a button -->
		<a href="add" class="btn btn-info col-2 btn-sm mb-3"> Add Student
		</a>
				...
				<c:forEach items="${Students}" var="tempStud">
					<tr>
						...
						<td>
							...
							<a href="delete?studentId=${tempStud.studentId}"
